...
def parse_opt(known=False):
    ...
    # parser.add_argument('--weights', type=str, default=ROOT / 'yol
    #
    # o.pt', help='initial weights path')
    # parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--weights', type=str, default='D:\\yolov9-main1\\yolov9-t-converted.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='D:\\yolov9-main1\\models\\detect\\yolov9-t.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='D:\\yolov8-8.2.36\\dataset-Br35H\\br35h.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='D:\\yolov9-main1\\data\\hyps\\hyp.scratch-high.yaml', help='hyperparameters path')
